...
| 运算 | 语法 | 显示效果 | 运算 | 语法 | 显示效果 |
| ----- | ----- | ----- | ----- | ----- | ----- |
| 逻辑或 | \vee | $\vee$ | 逻辑与 | \wedge | $\wedge$ |
| 逻辑或 | \bigvee | $\bigvee$ | 逻辑与 | \bigwedge | $\bigwedge$ |
...
| 并集 | \bigcup | $\bigcup$ | 交集 | \bigcap | $\bigcap$ |
...
| 曲线积分 | \oint | \oint_{\sum} P \mathrm{d} x \mathrm{d} z + Q \mathrm{d} z \mathrm{d} x + R \mathrm{d} x \mathrm{d} y | $\oint_{\sum} P \mathrm{d} x \mathrm{d} z + Q \mathrm{d} z \mathrm{d} x + R \mathrm{d} x \mathrm{d} y$ |
